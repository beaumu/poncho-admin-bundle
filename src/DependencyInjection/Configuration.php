    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('app_logo')
                    ->defaultNull()
                    ->info('Path of logo, used on light surfaces (login page, emails)')
                    ->end()
                ->scalarNode('app_logo_inverse')
                    ->defaultNull()
                    ->info('Path of logo used on dark surfaces (sidebar). Defaults to app_logo.')
                    ->end()
